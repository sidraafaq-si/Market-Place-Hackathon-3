  ...
  return (
    <section>
      <div className="bg-purple-300">
        <div className="py-12 text-black mt-12">
          <div className="flex flex-col md:flex-row">
            <div className="w-full md:w-[720px] h-auto px-4 md:px-12 py-8 flex flex-col justify-between">
              ...
              <div className="my-10">
                <button className="bg-[#F9F9F9] py-4 px-4 rounded-[5px] text-[#2A254B] w-[140px] h-[57px] bg-transparent text-gray border border-gray-600 font-bold mt-12 hover:bg-purple-900 hover:text-white active:bg-purple-400 transition duration-300">
                  Get in touch
                </button>
              </div>
            </div>
